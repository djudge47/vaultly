// Auto-generated Supabase types — mirrors the schema.sql
  ...
  public: {
    Tables: {
      ...
      billing_status: {
        ...
        Insert: Omit<Database['public']['Tables']['billing_status']['Row'], 'id' | 'created_at' | 'updated_at'>;
        Update: Partial<Database['public']['Tables']['billing_status']['Insert']>;
      };
      plaid_items: {
        Row: {
          id: string;
        ...
        Insert: Omit<Database['public']['Tables']['plaid_items']['Row'], 'id' | 'created_at'>;
      ...
      savings_events: {
        ...
        Insert: Omit<Database['public']['Tables']['savings_events']['Row'], 'id' | 'created_at'>;
